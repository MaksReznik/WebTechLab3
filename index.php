<!-- SELECT * FROM literature WHERE literate='Book' AND publisher='Генеза';
SELECT * FROM literature WHERE (literate='Book' OR literate='Journal' OR literate='Newspaper
') AND year between 2020 and 2022;
SELECT * FROM author INNER JOIN book_authrs ON author.Id=book_authrs.FID_AUTH AND author.Id=9 INNER JOIN literature ON book_authrs.FID_BOOK=literature.Id ; -->
<?php
...
$searchBooksByPublisherResult=$db->query("SELECT * FROM literature WHERE literate='Book' AND publisher='".$publisher."'");
